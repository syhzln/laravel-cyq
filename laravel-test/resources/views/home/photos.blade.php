            ...
            <div id="photo_second">
                <div id="photo_ulf" >
                    ...
                    <div class="photo_inright">
                        <form action="{{url('/home/upphoto/'.$aid)}}"  method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                        ...
                        @foreach($arr as $ar)
                            <div class="photo_photo">
                                ...
                                <div class="photo_from">
                                    <a href="">{{$ar['pname']}}</a>
                                    <a href="{{url('/home/delphos/'.$ar['id'])}}" style="text-align: center;">删除</a>
                                    <span>{{$status==1?'公开':'不公开'}}</span>
                                </div>
                            </div>
                        @endforeach
                    @endif
