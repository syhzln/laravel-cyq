    ...
    <div class="friends_out">
        ...
        @foreach($arr as $ar)
            ...
            <div class="friends_info">
                ...
                <a href="{{url('/home/doattention/'.$ar['id'])}}" class="btn btn-default  btn-sm" style="width: 130px;text-align: center">关注</a>
            ...
            <div class="friends_small friends_button">
                <div class="friends_smallpic">
                    ...
                    {{--<div style="width:164px;">--}}
                        <a href="{{url('/home/doattention/'.$ar['id'])}}"><button class="btn btn-default  btn-sm" >关注</button></a>
